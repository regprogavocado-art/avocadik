...
</style><div class="frame"><img class="mascot" alt="" src="${character}"><div class="left"><div class="brand">${mark}<div>Avocado<small>Разработка программного обеспечения</small></div></div><h1>Разрабатываем ПО.<br><span>На вашей стороне.</span></h1><div class="line">Защита от DDoS · Автоматизация<br>Инфраструктура для вашего проекта</div><div class="rule"></div><div class="privacy">Без KYC и проверки документов · Оплата криптовалютой</div></div></div></html>`);

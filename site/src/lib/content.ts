...
export const seedPages: Page[] = [
  ...
  },
  {
    "id": 4,
    "slug": "home",
    "title": "Разрабатываем ПО. Защищаем ваши возможности.",
    "summary": "Avocado — команда разработчиков. Создаём собственные продукты Hass и Ettinger, автоматизацию и решения под вашу задачу. Домены, серверы и прокси дополняют наше ПО.",
    "body": "Собственное ПО и разработка на заказ. Обсуждаем задачи конфиденциально, запрашиваем только необходимые для работы данные. Принимаем оплату криптовалютой.",
    "status": "published"
  },
  {
    "id": 5,
    "slug": "catalog",
    "title": "Инфраструктура для вашего ПО",
    "summary": "Домены, серверы и прокси дополняют программные продукты Avocado.",
  ...
  },
  {
    ...
    "summary": "Локации для ваших проектов.",
  ...
  },
  {
    ...
    "summary": "Обновления продуктов и новости инфраструктуры.",
  ...
  },
  {
    ...
    "slug": "category-vps",
    "title": "VPS",
    "summary": "Виртуальные серверы под задачи вашего проекта.",
    "body": "Виртуальные серверы Avocado для вашего ПО. Ориентировочные цены помогут оценить бюджет. Конфигурацию, локацию, наличие и итоговую стоимость проверим перед счётом.",
    "status": "published"
  },
  {
    "id": 12,
